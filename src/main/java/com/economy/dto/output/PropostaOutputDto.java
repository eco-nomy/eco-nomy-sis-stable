...
public class PropostaOutputDto {
    private int id;
    ...
    public PropostaOutputDto(int id, int empresaId, String descricao, BigDecimal valor, Date dataCriacao, int empregadoId, boolean isLongoPrazo, String status) {
        this.id = id;
